...
<div id="StickyLayer" style="position:fixed;text-align:left;left:auto;right:25px;top:auto;bottom:25px;width:50px;height:50px;z-index:18;">
...
<form name="contact" method="post" action="<?php echo basename(__FILE__); ?>" enctype="multipart/form-data" accept-charset="UTF-8" target="_blank" id="contact" onsubmit="return submitcontact()">
...
<input type="text" id="Editbox1" style="display:block;width: 100%;height:42px;z-index:6;" name="name" value="" spellcheck="false" placeholder="&#1048;&#1052;&#1071;">
<input type="text" id="Editbox2" style="display:block;width: 100%;height:42px;z-index:7;" name="email" value="" spellcheck="false" placeholder="&#1040;&#1044;&#1056;&#1045;&#1057; &#1069;&#1051;&#1045;&#1050;&#1058;&#1056;&#1054;&#1053;&#1053;&#1054;&#1049; &#1055;&#1054;&#1063;&#1058;&#1067;">
<textarea name="message" id="TextArea1" style="display:block;width: 100%;;height:108px;z-index:8;" rows="4" cols="35" autocomplete="off" spellcheck="false" placeholder="&#1050;&#1054;&#1052;&#1045;&#1053;&#1058;&#1040;&#1056;&#1048;&#1049;"></textarea>
<div id="wb_Text13">
<p>* Все поля обязательны для заполнения.</p>
</div>
<a id="Button2" href="mailto:oleynikalexey98@gmail.com" style="display:inline-block;width:92px;height:39px;z-index:10;">Отправить</a>
</div>
</div>
</div>
</form>
...
<div class="col-2">
<div id="wb_footerLabel2" style="display:inline-block;width:100%;z-index:11;">
...
<div id="wb_IconFont1" style="display:inline-block;width:18px;height:18px;text-align:center;z-index:13;">
<a href="https://vk.com/oleynikalexey"><div id="IconFont1"><i class="fa fa-vk"></i></div></a>
</div>
</div>
<div class="col-3">
<div id="wb_footerLabel3" style="display:inline-block;width:100%;z-index:14;">
<h3 id="footerLabel3">ПОЛЕЗНЫЕ ССЫЛКИ</h3>
</div>
<div id="wb_footerMenu" style="display:inline-block;width:100%;z-index:15;">
